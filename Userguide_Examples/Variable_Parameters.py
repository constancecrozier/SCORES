...
This example demonstrates the timesaving advantage of changing parameters rather than reforming the model completly.
...
#### Naive Method Done by Model Reforming ####
...
#### Fast Method Done by updating Parameters ####
x.Form_Model()
